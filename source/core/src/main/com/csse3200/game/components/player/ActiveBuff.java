 ...
 *
 * <p>Instances are created by {@link PlayerBuffComponent} and are read-only, so a future UI
 * component such as a buff timer can display them without changing buff state.
 */
public class ActiveBuff {
   ...
   */
  public ActiveBuff(BuffStat stat, float magnitude, float durationSeconds, long endTime) {
    this.stat = stat;
   ...
   * @return remaining seconds, with a minimum of 0
   */
