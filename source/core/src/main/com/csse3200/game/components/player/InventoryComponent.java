 ...
 *
 * <p>Currently stores the player's gold amount but can be extended for more advanced functionality
 * such as storing items. Can also be used as a more generic component for other entities.
 */
public class InventoryComponent extends Component {
  ...
  /**
   * Creates an inventory with the specified amount of gold.
   *
