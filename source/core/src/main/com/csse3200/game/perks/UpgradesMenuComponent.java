...
/**
 * Tracks whether the Upgrades screen is currently open. Mirrors PauseMenuComponent's
 * isPaused()/toggleIsPaused() pattern - the Upgrades screen is an overlay toggled on/off, not a
 * separate ScreenType.
 */
