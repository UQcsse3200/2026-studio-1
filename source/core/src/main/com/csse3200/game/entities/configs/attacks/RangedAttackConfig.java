 ...
 * com.csse3200.game.components.attacks.RangedAttackComponent}) rather than resolving damage instantly -
 * {@code range} and {@code cooldown} still gate when a shot is <i>fired</i>, the same as melee, but
 * whether it actually lands is resolved later by the arrow itself. The default {@code range} here
